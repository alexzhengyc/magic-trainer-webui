...
def train(args):
    ...
    # Experimentally: perform fp16 learning including gradients PyTorch applies patches and enables grad scale with fp16
    if args.full_fp16:
    ...
    for epoch in range(num_train_epochs):
        ...
        # Train text encoder until specified step: initial state of epoch
        unet.train()
        ...
        for step, batch in enumerate(train_dataloader):
            # Stop the learning of Text Encoder in the specified number of steps
            ...
            with accelerator.accumulate(unet):
                ...
                loss = loss.mean()  # Average so no need to divide by batch_size
